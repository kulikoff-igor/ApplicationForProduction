...
/**
 * Created by IT-1 on 27.02.14.
 */
public class RemoveApplicationData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        db.removeApplicationData(idApplication, pipeType, pe, sdr, pipeWall, pipeDiametr, unit, amount, segments);
    }
}
